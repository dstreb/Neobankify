...
// =====================================================
const MOCK_ACCOUNTS = [
  { id: '1', name: 'Personal', type: 'Checking', lastFour: '8815', balance: 4522.25, icon: 'wallet-outline' as const },
  { id: '2', name: 'Savings', type: 'Savings', lastFour: '1179', balance: 8458.22, icon: 'cash-outline' as const },
  { id: '3', name: 'Credit', type: 'Credit', lastFour: '9718', balance: 1858.58, icon: 'card-outline' as const },
];

const MOCK_TRANSACTIONS = [
  { id: '1', type: 'Transfer', description: 'To Jane Doe \u2022\u20222287', amount: -1250.00, icon: 'swap-horizontal-outline' as const },
  { id: '2', type: 'Withdraw', description: 'From Savings \u2022\u20228813', amount: -52.25, icon: 'arrow-down-outline' as const },
  { id: '3', type: 'Deposit', description: 'To Primary \u2022\u20228872', amount: 7.55, icon: 'arrow-up-outline' as const },
