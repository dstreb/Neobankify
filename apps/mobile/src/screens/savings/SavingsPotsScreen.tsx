...
// Types
// =====================================================
type PotIcon = 'airplane' | 'home' | 'school' | 'car' | 'heart' | 'gift' | 'briefcase' | 'leaf' | 'star' | 'rocket';
type PotColor = string;
...
const POT_ICONS: { icon: PotIcon; label: string }[] = [
...
const POT_COLORS: PotColor[] = [
  '#EF4444', '#F97316', '#EAB308', '#22C55E',
  '#14B8A6', '#3B82F6', '#8B5CF6', '#EC4899',
  '#0369A1', '#059669',
];

const FREQUENCY_OPTIONS = ['Daily', 'Weekly', 'Monthly', 'Custom Frequency'];
